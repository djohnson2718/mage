...
public class LoadTest_drew {
    ...
    public static void main(String[] args) {
        LoadTest_drew x= new LoadTest_drew();
        LoadTestGameResultsList rl = x.new LoadTestGameResultsList();
        LoadTestGameResult result = rl.createGame(0, "ai_test", 1);
        x.playTwoAIGame("ai_test", "UB", "M20", result);
    }
